...
static UniValue xrGetTransaction(const JSONRPCRequest& request)
{
    ...
    * This is only returned if using a "node_count" greater than 1.
                ...
                RPCExamples{
                    HelpExampleCli("xrGetTransaction", "REPT 97578005939f0c25afd6358772ad1ff90f6e2e089d552c7acb9c10c56d983c1e")
                  + HelpExampleRpc("xrGetTransaction", "\"REPT\", \"97578005939f0c25afd6358772ad1ff90f6e2e089d552c7acb9c10c56d983c1e\"")
                  + HelpExampleCli("xrGetTransaction", "REPT 97578005939f0c25afd6358772ad1ff90f6e2e089d552c7acb9c10c56d983c1e 2")
                  + HelpExampleRpc("xrGetTransaction", "\"REPT\", \"97578005939f0c25afd6358772ad1ff90f6e2e089d552c7acb9c10c56d983c1e\", 2")
                },
            }.ToString());
...
static UniValue xrDecodeRawTransaction(const JSONRPCRequest& request)
{
    ...
    * This is only returned if using a "node_count" greater than 1.
                ...
                RPCExamples{
                    HelpExampleCli("xrDecodeRawTransaction", "REPT ")
                  + HelpExampleRpc("xrDecodeRawTransaction", "\"REPT\", \"\"")
                  + HelpExampleCli("xrDecodeRawTransaction", "REPT  2")
                  + HelpExampleRpc("xrDecodeRawTransaction", "\"REPT\", \"\", 2")
                },
...
static UniValue xrGetBlocks(const JSONRPCRequest& request)
{
    ...
    * This is only returned if using a "node_count" greater than 1.
                ...
                RPCExamples{
                    HelpExampleCli("xrGetBlocks", "REPT \"39e11e62d89cfcfd2b0800f7e9b4bd439fa44a7d7aa111e1e7a8b235d848eadf,7b41ea6a8bf0ed93fd4f3a6a67a558941634400e9eaa51676d5af5077a01760c\"")
                  + HelpExampleRpc("xrGetBlocks", "\"REPT\", \"39e11e62d89cfcfd2b0800f7e9b4bd439fa44a7d7aa111e1e7a8b235d848eadf,7b41ea6a8bf0ed93fd4f3a6a67a558941634400e9eaa51676d5af5077a01760c\"")
                  + HelpExampleCli("xrGetBlocks", "REPT \"39e11e62d89cfcfd2b0800f7e9b4bd439fa44a7d7aa111e1e7a8b235d848eadf,7b41ea6a8bf0ed93fd4f3a6a67a558941634400e9eaa51676d5af5077a01760c\" 2")
                  + HelpExampleRpc("xrGetBlocks", "\"REPT\", \"39e11e62d89cfcfd2b0800f7e9b4bd439fa44a7d7aa111e1e7a8b235d848eadf,7b41ea6a8bf0ed93fd4f3a6a67a558941634400e9eaa51676d5af5077a01760c\", 2")
                },
            }.ToString());
    ...
    for (const auto & hash : blockHashes) {
        if (hash.empty() || hash.find(',') != std::string::npos) {
            ...
            error.pushKV("error", "block_hashes must be specified in a comma-delimited string with no spaces.\n"
                                        "Example: xrGetBlocks REPT \"302a309d6b6c4a65e4b9ff06c7ea81bb17e985d00abdb01978ace62cc5e18421,"
...
static UniValue xrGetTransactions(const JSONRPCRequest& request)
{
    ...
    * This is only returned if using a "node_count" greater than 1.
                ...
                RPCExamples{
                    HelpExampleCli("xrGetTransactions", "REPT \"6582c8028f409a98c96a73e3efeca277ea9ee43aeef174801c6fa6474b66f4e7,4d4db727a3b36e6689af82765cadabb235fd9bdfeb94de0210804c6dd5d2031d\"")
                  + HelpExampleRpc("xrGetTransactions", "\"REPT\", \"6582c8028f409a98c96a73e3efeca277ea9ee43aeef174801c6fa6474b66f4e7,4d4db727a3b36e6689af82765cadabb235fd9bdfeb94de0210804c6dd5d2031d\"")
                  + HelpExampleCli("xrGetTransactions", "REPT \"6582c8028f409a98c96a73e3efeca277ea9ee43aeef174801c6fa6474b66f4e7,4d4db727a3b36e6689af82765cadabb235fd9bdfeb94de0210804c6dd5d2031d\" 2")
                  + HelpExampleRpc("xrGetTransactions", "\"REPT\", \"6582c8028f409a98c96a73e3efeca277ea9ee43aeef174801c6fa6474b66f4e7,4d4db727a3b36e6689af82765cadabb235fd9bdfeb94de0210804c6dd5d2031d\", 2")
                },
            }.ToString());
    ...
    for (const auto & hash : txHashes) {
        if (hash.empty() || hash.find(',') != std::string::npos) {
            ...
            error.pushKV("error", "tx_ids must be specified in a comma-delimited string with no spaces.\n"
                                        "Example: xrGetTransactions REPT \"24ff5506a30772acfb65012f1b3309d62786bc386be3b6ea853a798a71c010c8,"
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"xrGetTxBloomFilter",
                ...
                RPCExamples{
                    HelpExampleCli("xrGetTxBloomFilter", "REPT 0x0000000018")
                  + HelpExampleRpc("xrGetTxBloomFilter", "\"REPT\", \"0x0000000018\"")
                  + HelpExampleCli("xrGetTxBloomFilter", "REPT 0x0000000018 2")
                  + HelpExampleRpc("xrGetTxBloomFilter", "\"REPT\", \"0x0000000018\", 2")
                },
            }.ToString());
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"xrGenerateBloomFilter",
                ...
                RPCExamples{
                    HelpExampleCli("xrGenerateBloomFilter", "REPT \"BXziudHsEee8vDTgvXXNLCXwKouSssLMQ3,BgSDpy7F7PuBZpG4PQfryX9m94NNcmjWAX\"")
                  + HelpExampleRpc("xrGenerateBloomFilter", "\"REPT\", \"BXziudHsEee8vDTgvXXNLCXwKouSssLMQ3,BgSDpy7F7PuBZpG4PQfryX9m94NNcmjWAX\"")
                  + HelpExampleCli("xrGenerateBloomFilter", "REPT \"BXziudHsEee8vDTgvXXNLCXwKouSssLMQ3,BgSDpy7F7PuBZpG4PQfryX9m94NNcmjWAX\" 2")
                  + HelpExampleRpc("xrGenerateBloomFilter", "\"REPT\", \"BXziudHsEee8vDTgvXXNLCXwKouSssLMQ3,BgSDpy7F7PuBZpG4PQfryX9m94NNcmjWAX\", 2")
                },
            }.ToString());
...
static UniValue xrSendTransaction(const JSONRPCRequest& request)
{
    ...
    uuid         | str  | The response ID, which can be used to view this response again
                ...
                RPCExamples{
                    HelpExampleCli("xrSendTransaction", "REPT ")
                  + HelpExampleRpc("xrSendTransaction", "\"REPT\", \"\"")
                },
            }.ToString());
    ...
    [
      {
        ...
        "config": "[Main]\nwallets=BTC,ETH,LTC,REPT,CRW,MERGE,TRC\nmaxfee=0\n[BTC::xrGetBlocks]\n#fee=0.1\n#clientrequestlimit=-1\ndisabled=0\nfetchlimit=50\n\n\n",
        "plugins": {
        }
      },
      {
...
static UniValue xrConnect(const JSONRPCRequest& request)
{
    ...
    if (service.empty()) {
        UniValue error(UniValue::VOBJ);
        error.pushKV("error", "Service not specified. Example: xrConnect xr::REPT");
        error.pushKV("code", xrouter::INVALID_PARAMETERS);
        return error;
    }
...
static UniValue xrGetNetworkServices(const JSONRPCRequest& request)
{
    ...
    {
      "reply": {
        "spvwallets": [ "xr::REPT", "xr::BTC", "xr::LTC", "xr::MNP", "xr::SYS" ],
