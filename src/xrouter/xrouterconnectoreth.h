...
#ifndef REPTILOIDSCOIN_XROUTER_XROUTERCONNECTORETH_H
#define REPTILOIDSCOIN_XROUTER_XROUTERCONNECTORETH_H
...
#endif // REPTILOIDSCOIN_XROUTER_XROUTERCONNECTORETH_H
