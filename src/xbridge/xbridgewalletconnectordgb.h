...
#ifndef REPTILOIDSCOIN_XBRIDGE_XBRIDGEWALLETCONNECTORDGB_H
#define REPTILOIDSCOIN_XBRIDGE_XBRIDGEWALLETCONNECTORDGB_H
...
#endif // REPTILOIDSCOIN_XBRIDGE_XBRIDGEWALLETCONNECTORDGB_H
