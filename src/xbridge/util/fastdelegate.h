...
#ifndef REPTILOIDSCOIN_XBRIDGE_UTIL_FASTDELEGATE_H
#define REPTILOIDSCOIN_XBRIDGE_UTIL_FASTDELEGATE_H
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
...
struct SimplifyMemFunc {
    ...
    inline static GenericClass *Convert(X */*pthis*/, XFuncType /*function_to_bind*/,
        ...
        static_assert(N <= 100, "ERROR_Unsupported_member_function_pointer_on_this_compiler");
		return 0; 
	}
};
...
struct SimplifyMemFunc< SINGLE_MEMFUNCPTR_SIZE + sizeof(int) >  {
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
        ...
        static_assert(sizeof(function_to_bind)==sizeof(u.s), "ERROR_CantUsehorrible_cast");
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
        ...
        static_assert(sizeof(XFuncType)==sizeof(u.s), "ERROR_CantUsehorrible_cast");
		u.func = function_to_bind;
		bound_func = u.s.funcaddress;
		int virtual_delta = 0;
...
// support static_cast between void * and function pointers.
	...
	inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker, 
        ...
        static_assert(sizeof(GenericClass *)==sizeof(function_to_bind), "ERROR_CantUseEvilMethod");
...
#endif // !defined(REPTILOIDSCOIN_XBRIDGE_UTIL_FASTDELEGATE_H)
