...
void BitcoinApplication::createWindow(const NetworkStyle *networkStyle)
{
    ...
    window = new BitcoinGUI(m_node, platformStyle, networkStyle, nullptr);
        ...
        window = new ReptiloidsCoinGUI(m_node, platformStyle, networkStyle, nullptr);
#endif // ENABLE_WALLET
...
void BitcoinApplication::createSplashScreen(const NetworkStyle *networkStyle)
{
    ...
    connect(this, &BitcoinApplication::requestedShutdown, splash, &QWidget::close);
        ...
        auto *splash = new ReptiloidsCoinSplashScreen(m_node, nullptr, networkStyle);
        // We don't hold a direct pointer to the splash screen after creation, but the splash
        // screen will take care of deleting itself when finish() happens.
        splash->show();
        connect(this, &BitcoinApplication::splashFinished, splash, &ReptiloidsCoinSplashScreen::finish);
        connect(this, &BitcoinApplication::requestedShutdown, splash, &QWidget::close);
    }
}
...
#ifdef ENABLE_WALLET
    if (!isClassic())
        connect(dynamic_cast<ReptiloidsCoinGUI*>(window), &ReptiloidsCoinGUI::requestedRestart, executor, &BitcoinCore::restart);
#endif // ENABLE_WALLET
...
{
    QMessageBox::critical(nullptr, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. ReptiloidsCoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
