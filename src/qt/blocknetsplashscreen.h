 ...
 */
class BlocknetSplashScreen : public QWidget
{
    Q_OBJECT

public:
    explicit BlocknetSplashScreen(interfaces::Node& node, Qt::WindowFlags f, const NetworkStyle *networkStyle);
    ~BlocknetSplashScreen();
