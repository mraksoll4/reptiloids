...
private:
    ...
    static constexpr double SHORT_DECAY = .84; // ReptiloidsCoin short decay
    /** Decay of .9259 is a half-life of 10 blocks or about 10 minutes */
    static constexpr double MED_DECAY = .9259; // ReptiloidsCoin medium decay
    /** Decay of .9825 is a half-life of 40 blocks or about 40 minutes */
    static constexpr double LONG_DECAY = .9825; // ReptiloidsCoin long decay
