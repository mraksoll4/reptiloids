...
static const unsigned int DEFAULT_REPT_RECONSTRUCTION_EXTRA_TXN = 100;
...
struct QueuedBlock {
    ...
    std::unique_ptr<PartiallyDownloadedBlock> partialBlock;  //!< Optional, used for CMPCTREPT downloads
};
