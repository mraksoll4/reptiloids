...
- #10618 `f90603a` Remove confusing MAX_REPT_BASE_SIZE (gmaxwell)
...
- #10988 `a9dd111` qt: Increase REPT_CHAIN_SIZE constants (laanwj)
...
- #10186 `c9ff4f8` Remove SYNC_TRANSACTION_NOT_IN_REPT magic number (jnewbery)
...
- #10608 `eee398f` Add a comment explaining the use of MAX_REPT_BASE_SIZE (gmaxwell)
