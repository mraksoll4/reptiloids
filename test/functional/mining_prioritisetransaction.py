...
from test_framework.messages import COIN, MAX_REPT_BASE_SIZE
...
class PrioritiseTransactionTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # MAX_REPT_BASE_SIZE -- otherwise the test needs to be revised to create
        # more transactions.
        ...
        for i in range(3):
            ...
            assert(sizes[i] > MAX_REPT_BASE_SIZE) # Fail => raise utxo_count
